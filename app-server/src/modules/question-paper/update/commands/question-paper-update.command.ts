...
export class QuestionPaperUpdateCommand implements IQuestionPaperUpdateCommand {
  private data: object;
  ...
  validate(): { isValid: boolean; errors: string[] } {
    const dto = plainToInstance(QuestionPaperUpdateDto, this.data);
  ...
  async execute(): Promise<void> {
    const updateData = plainToInstance(QuestionPaperUpdateDto, this.data);
